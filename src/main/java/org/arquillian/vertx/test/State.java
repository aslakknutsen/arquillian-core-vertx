...
public class State
{
   ...
   private static ThreadLocal<ArquillianAdapter> arquillianAdapter = new ThreadLocal<ArquillianAdapter>();
   ...
   static void setAdaptor(ArquillianAdapter adaptor)
   {
      arquillianAdapter.set(adaptor);
   }
   
   static boolean hasAdaptor()
   {
      return getAdaptor() != null;
   }
   
   static ArquillianAdapter getAdaptor()
   {
      return arquillianAdapter.get();
   }
